...
// TODO
void Snake::deplacerVersXY(int x,
                           int y
) {
...
void Snake::agrandirSerpent(Direction dir
  ...
  switch (dir) {
    case Direction::haut :++coord.y;
      break;
    case Direction::bas :--coord.y;
      break;
    case Direction::droite :--coord.x;
      break;
    case Direction::gauche :++coord.x;
      break;
  }
